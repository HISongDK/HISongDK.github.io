...
```js
var directions = [Directions.Up,Directions.Down,Directios.Left,Directions.Right]
```
...
由于很多第三方库是 commonjs 规范的，所以声明文件也就不得不使用到 export = 这种语法了。但是还是需要强调下，相比export = ，我们更推荐使用 ES6 标准的 export default 和 export。
